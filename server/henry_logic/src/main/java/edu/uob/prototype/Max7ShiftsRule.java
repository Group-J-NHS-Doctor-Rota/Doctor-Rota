...
public class Max7ShiftsRule extends Rule {
    ...
    public Max7ShiftsRule(Shift day1, Shift day2, Shift day3, Shift day4,
                              Shift day5, Shift day6, Shift day7, Shift day8) {
        shifts = new HashMap<>();
    ...
    public void refresh() {
        ...
        broken = !isDay8NotWorking();
    }

    private boolean isDay8NotWorking() {
        return shifts.get("day8").getType().equals(ShiftTypes.NotWorking);
    }
