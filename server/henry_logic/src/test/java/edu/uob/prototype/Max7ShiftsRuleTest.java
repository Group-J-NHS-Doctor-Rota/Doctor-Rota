...
public class Max7ShiftsRuleTest {
    ...
    void testBasicShiftsAndRules() {
        ...
        Rule r1 = new Max7ShiftsRule(s1, s1, s1, s1, s1, s1, s1, s1);
        assertFalse(r1.isBroken(), "No working, rule should be met");
        assertEquals(0, r1.getCost(), "0 cost expected");
        // 7 days of work then not working day, rule should be met
        Rule r2 = new Max7ShiftsRule(s2, s2, s2, s2, s2, s2, s2, s1);
        ...
        Rule r3 = new Max7ShiftsRule(s3, s3, s3, s3, s3, s3, s3, s3);
        ...
        Rule r4 = new Max7ShiftsRule(s4, s4, s4, s4, s4, s1, s4, s4);
